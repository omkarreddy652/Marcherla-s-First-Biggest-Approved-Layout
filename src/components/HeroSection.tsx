    ...
    <section className="relative overflow-hidden">
      ...
      <div className="container relative z-10 mx-auto px-4 py-16 md:py-24 lg:py-28">
        ...
        <div className="mt-8 flex flex-wrap items-center justify-center gap-3">
          ...
          <a href={`tel:${CONTACT_PHONE.tel}`} className="flex items-center gap-1.5 rounded-full gradient-gold px-4 py-2 shadow-gold transition-transform hover:scale-105">
